...
class DefaultDialect(interfaces.Dialect):
    ...
    def do_commit(self, dbapi_connection):
        with logged_duration(message="Commit to DB finished in {duration_real}s of real-time", condition=None):
    ...
    def do_execute(self, cursor, statement, parameters, context=None):
        with logged_duration(message="Execute to DB finished in {duration_real}s of real-time", condition=None):
